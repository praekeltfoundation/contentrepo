...
class TestHasNextMessage:
    ...
    def test_has_next_message_whatsapp(self):
    ...
    def test_has_next_message_viber_no_next_message(self):
    ...
    def test_has_next_message_on_last_message(self):
...
class TestHasPreviousMessage:
    ...
    def test_has_previous_message_at_first_message(self):
...
class TestFormatMessage:
    ...
    def test_format_whatsapp_message_happy_case_no_variation_messages(self):
        page = self.create_content_page(wa_body_count=1)
        result = format_whatsapp_message(0, page, "whatsapp")
        expected_result = {
            "type": "Whatsapp_Message",
