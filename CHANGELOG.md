...
- Standalone Templates correctly use the current live version

### Security

## v1.6.1 - 2026-05-21 - BROKEN
...
- Add Live + Draft status for WhatsApp Templates
- Add support for Workflows for WhatsApp Templates
